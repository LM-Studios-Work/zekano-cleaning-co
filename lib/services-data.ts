...
export const allServices: ServiceData[] = [
  // Residential Cleaning
  {
    ...
    benefits: [
      ...
      "Same team assigned to your home each visit",
  ...
  },
  {
    ...
    category: "Residential Cleaning",
    categorySlug: "residential-cleaning",
    description: "A full top-to-bottom clean that reaches every surface, appliance interior, and hidden corner.",
  ...
  },
  {
    ...
    category: "Residential Cleaning",
    categorySlug: "residential-cleaning",
    description: "Whether you're handing back keys or settling into a new place, we make sure the property is spotless.",
  ...
  // Commercial Cleaning
  {
    ...
    benefits: [
      ...
      "Consistent team assigned to your office",
      "Scalable service for growing businesses",
    ],
    process: [
      "We conduct an initial site visit to assess your office needs.",
      "A custom cleaning schedule is created around your business hours.",
      "Our team cleans all workstations, common areas, and restrooms.",
      "Kitchen and break room areas are sanitised and restocked.",
      "Floors are vacuumed, mopped, or carpet-cleaned as needed.",
      "Regular quality checks ensure consistent standards.",
    ],
  },
  {
  ...
  },
  {
    ...
    features: [
      ...
      "Smoke and odour elimination",
      "Stain treatment and removal",
      "Careful handling of all fabric types",
      "Re-hanging service available",
      "Colour restoration",
    ],
    benefits: [
      "Improves indoor air quality",
      "Extends curtain lifespan",
      "No need to replace faded curtains",
      "Convenient on-site option available",
      "Gentle on delicate and designer fabrics",
    ],
    process: [
      "We assess the fabric type and recommend the best cleaning method.",
      "Curtains are carefully removed (if off-site cleaning).",
      "Pre-treatment is applied to stains and soiled areas.",
      "Deep cleaning removes dust, allergens, and odours.",
      "Curtains are pressed or steamed for a fresh finish.",
      "Re-hanging is done carefully to ensure proper draping.",
    ],
  },
  {
  ...
  },
  {
    ...
    features: [
      ...
      "CCTV drain inspection available",
    ...
    benefits: [
      ...
      "Restores full drainage flow",
      "Identifies problems before they escalate",
      "Available for emergency blockages",
    ],
    process: [
      "We assess the drainage issue and identify the blockage location.",
      "The appropriate clearing method is selected.",
      "High-pressure jetting or mechanical clearing removes the blockage.",
      "The drain is flushed to confirm full flow restoration.",
      "We advise on any recurring issues found.",
      "A maintenance plan can be set up to prevent future problems.",
    ],
  },
  {
    ...
    longDescription: "An overgrown or untidy garden can bring down the look of your entire property. Our garden clean-up service covers everything from clearing debris and trimming overgrowth to general tidying and waste removal. Whether it's a neglected garden that needs a fresh start or regular maintenance to keep things looking neat, we've got you covered. Available across Johannesburg and surrounding areas.",
