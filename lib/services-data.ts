...
export const allServices: ServiceData[] = [
  ...
  },
  {
    ...
    category: "Upholstery & Fabric Cleaning",
    categorySlug: "upholstery-and-fabric",
    description: "Expert on-site curtain and blinds cleaning that removes dust, allergens, and odours while they hang.",
    longDescription: "Professional On-Site Curtain Cleaning in Johannesburg. We specialise in deep-cleaning curtains and blinds while they remain hanging — saving you the hassle of removal and re-installation. Using deep steam extraction, we remove dust, allergens, and odours from drapes, sheers, and Roman blinds with industrial-grade equipment.",
    image: "/Curtain-Cleaning.jpg",
    icon: "Wind",
    features: [
      "On-site cleaning (no removal needed)",
      "Deep steam extraction technology",
      "Dust and allergen sanitisation",
      "Fabric integrity care for delicate silks",
      "Roman blinds and vertical treatments",
      "Stain treatment and deodorising",
      "All Johannesburg suburbs covered",
      "Nature-friendly cleaning products",
    ],
    benefits: [
      "Improve air quality by removing allergens",
      "Zero hassle: no removal or re-hanging",
      "Extends the lifespan of expensive fabrics",
      "Safe for home, children, and pets",
      "Restores colour and freshness instantly",
    ],
    process: [
      "Pre-inspection for fabric type and colour fastness.",
      "Industrial vacuuming to remove surface debris.",
      "Targeted treatment of visible stains.",
      "Deep steam cleaning using specialized equipment.",
      "Final deodorising for a fresh-smelling finish.",
    ],
  },
  {
  ...
  },
  {
    ...
    category: "Specialised Cleaning Services",
    categorySlug: "specialised-cleaning",
    description: "Expert drain cleaning for blocked toilets, slow showers, and kitchen sinks using professional machinery.",
    longDescription: "Expert Drain Cleaning Services in Johannesburg. We focus on the efficiency and health of your plumbing system, delivering professional unblocking and maintenance services for homes and businesses across Gauteng. We use electro-mechanical cables and high-pressure jetting to clear stubborn blockages in sinks, toilets, and sewer lines with transparent, up-front pricing.",
    ...
    features: [
      ...
      "CCTV drain inspections available",
      "Root intrusion removal",
      "Main sewer line maintenance",
      "Free transparent up-front quotes",
      "Emergency blocked drain assistance",
    ],
    benefits: [
      "Prevents costly water damage and odours",
      "Direct owner supervision and accountability",
    ...
    process: [
      "Initial assessment of the source of the blockage.",
      "Provision of a free, transparent up-front quote.",
      "Mechanical or high-pressure clearing of the drain.",
      "Testing ensures water flow is fully restored.",
      "Inspection to ensure the site is left clean.",
    ],
  },
  {
