              ...
              <div className="lg:col-span-2 p-10 lg:p-14 flex flex-col justify-between" style={{ backgroundColor: "#1a1a1a" }}>
                <div>
                  ...
                  <h2 className="mt-4 text-3xl lg:text-4xl font-bold text-white leading-tight text-balance">
                    Why Choose Zenako for Regular Cleaning
                  </h2>
                  <p className="mt-6 text-white/60 leading-relaxed">
                    Consistent upkeep with the accountability and familiarity that actually makes a difference.
                  </p>
                </div>
                <div className="mt-12 pt-8 border-t border-white/10">
                  <div className="text-5xl font-black text-white">100%</div>
                  <div className="text-sm text-white/50 mt-1 uppercase tracking-widest">Satisfaction Guarantee</div>
                </div>
              </div>
              {/* Right card grid */}
            ...
            <div className="mb-14">
              ...
              <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-4 mt-3">
                ...
                <p className="text-muted-foreground max-w-md leading-relaxed">
                  From your first conversation to ongoing maintenance — simple, transparent, no surprises.
                </p>
              </div>
            </div>
            <div className="divide-y divide-border">
              {steps.map((step, idx) => (
                <div key={idx} className="py-10 grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-12 items-start">
                  <div className="lg:col-span-2 flex items-start gap-4 lg:block">
                    <span
                      className="text-6xl lg:text-7xl font-black leading-none"
                      style={{ color: "#6fbf00", opacity: 0.25 }}
                    >
                      {step.number}
                    </span>
                  </div>
