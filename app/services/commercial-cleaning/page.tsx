...
const categoryName = "Commercial Cleaning"
...
const categoryImage = "https://images.unsplash.com/photo-1497366216548-37526070297c?w=1200&q=80"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="mt-4 text-lg text-muted-foreground leading-relaxed">
                  {categoryDesc} Proudly servicing corporate offices, retail stores, and small businesses in Sandton, Randburg, Midrand, and greater Johannesburg.
                </p>
          ...
          <div className="mx-auto max-w-7xl px-4 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-foreground sm:text-4xl text-balance">
                Our <span style={{ color: "#1A9AD2" }}>{categoryName}</span> Solutions
              </h2>
              <p className="mt-4 text-lg text-muted-foreground max-w-2xl mx-auto">
                Discover how we can customize a cleaning program to suit your exact business needs and operating hours.
              </p>
            </div>
          ...
          <div className="mx-auto max-w-3xl px-4 lg:px-8">
            ...
            <div className="space-y-6">
              <div className="bg-white p-6 rounded-lg shadow-sm border border-border">
                <h3 className="text-lg font-bold text-foreground mb-2">Can you clean after business hours?</h3>
                <p className="text-muted-foreground text-sm">Yes. We understand you need minimal disruption to your daily operations. We offer flexible scheduling, including evenings and weekends.</p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-sm border border-border">
